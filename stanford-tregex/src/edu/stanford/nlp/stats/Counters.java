...
public class Counters {
  ...
  public static <T1, T2> void save2DCounterSorted(TwoDimensionalCounterInterface<T1, T2> tdc, String filename) throws IOException {
    PrintWriter out = new PrintWriter(new FileWriter(filename));
    for (T1 outer : tdc.firstKeySet()) {
      Counter c = tdc.getCounter(outer);
  ...
  /**
   * Default comparator for breaking ties in argmin and argmax. //TODO: What
   * type should this be? // Unused, so who cares? private static final
   * Comparator<Object> hashCodeComparator = new Comparator<Object>() { public
   * int compare(Object o1, Object o2) { return o1.hashCode() - o2.hashCode(); }
   * 
   * public boolean equals(Comparator comparator) { return (comparator == this);
   * } };
   */
